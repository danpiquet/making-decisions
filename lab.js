...
} else {'Coding has its challenges.'};
...
if (temperature >= 80 && rain === true) {
  console.log('Bring a t-shirt and an umbrella');
} else if (temperature >= 80 && rain === false) {
  console.log('Bring a t-shirt and forget your umbrella');
